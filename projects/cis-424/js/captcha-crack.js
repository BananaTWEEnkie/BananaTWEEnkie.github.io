var image_data = 'images/captcha.jpg';
var cropped_canvas = document.getElementById("canvas2");
...
cropped_canvas.getContext("2d").beginPath();
...
cropped_canvas.getContext("2d").closePath();